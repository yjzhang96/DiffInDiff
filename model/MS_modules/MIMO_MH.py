...
class Head(nn.Module):
    def __init__(self, in_channel, out_channel,head_num):
...
class MIMOUNet(nn.Module):
    def __init__(self, num_res=8, degrade_num=4):
        ...
        self.Head1 = Head(3, base_channel, degrade_num)
        self.Head2 = Head(3,base_channel * 2, degrade_num)
        self.Head3 = Head(3,base_channel * 4, degrade_num)

    def forward(self, x, index=None):
        x_2 = F.interpolate(x, scale_factor=0.5)
        x_4 = F.interpolate(x_2, scale_factor=0.5)
        x_ = self.Head1(x, index)
        z2 = self.Head2(x_2, index)
        z4 = self.Head3(x_4, index)
        z2 = self.SCM2(z2)
        z4 = self.SCM1(z4)
